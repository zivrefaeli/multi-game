...
import pygame
from pygame import display, event, mouse, time

from objects.clone import Clone
from objects.constants import FPS, HEIGHT, WHITE, WIDTH, Data
...
from client.cui import ClientUI
...
class ClientConnection(Thread):
    ...
    def run(self) -> None:
        while self.running:
            ...
            self.database = data[HandleClient.CLIENTS]
            damage = data[HandleClient.DAMAGE]
